    ...
    //Test bin_insertion_sort

    void test_single_element_int_array() {
        int singleArr[] = {5};
        int singleArrExpected[] = {5};

        bin_insertion_sort(singleArr, 1, sizeof(int), compare_integers);

        TEST_ASSERT_EQUAL_INT_ARRAY(singleArrExpected, singleArr, 1);
    }

    void test_equal_int_array() {
        int equalArr[] = {2, 2, 2, 2, 2};
        int equalArrExpected[] = {2, 2, 2, 2, 2};

        bin_insertion_sort(equalArr, 5, sizeof(int), compare_integers);

        TEST_ASSERT_EQUAL_INT_ARRAY(equalArrExpected, equalArr, 5);
    }

    void test_generic_int_array() {
        ...
        bin_insertion_sort(genericArr, 50, sizeof(int), compare_integers);
    ...
    void test_string_array() {
     ...
     "world"};
        ...
        bin_insertion_sort(stringArr, 30, sizeof(char*), compare_strings);
    ...
    void test_merge_single_element_int_array() {
        ...
        merge_binary_insertion_sort(singleArr, 1, sizeof(int), K_VALUE, compare_integers);
    ...
    void test_merge_equal_int_array() {
        ...
        merge_binary_insertion_sort(equalArr, 5, sizeof(int), K_VALUE, compare_integers);
        TEST_ASSERT_EQUAL_INT_ARRAY(equalArrExpected, equalArr, 5);
    }
    ...
    void test_mergee_gneric_int_array() {
        ...
        merge_binary_insertion_sort(genericArr, 50, sizeof(int), K_VALUE, compare_integers);
    ...
    void test_merge_string_array() {
     ...
     "world"};
        ...
        merge_binary_insertion_sort(stringArr, 30, sizeof(char *), K_VALUE, compare_strings);
        TEST_ASSERT_EQUAL_STRING_ARRAY(stringArrExpected, stringArr, 30);
    }
    ...
    int main() {
        ...
        RUN_TEST(test_single_element_int_array);
        RUN_TEST(test_equal_int_array);
